-- 044_leads_website_field.sql
-- Add website column to leads and extend lead RPCs to accept it.

alter table public.leads
  add column if not exists website text;

-- Recreate iwish.rpc_lead_create to accept website while keeping 042 semantics
...
-- Recreate iwish.rpc_lead_update to propagate website while keeping 042 semantics
