...
type Allocation = {
  ...
  source: string | null; budget: number | null; closed_at: string; allocation_status: string; categories: { id: number; name: string }[]
